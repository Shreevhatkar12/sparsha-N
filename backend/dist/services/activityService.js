...
export async function listActivities(user, params) {
...
export async function getActivity(user, activityId) {
    ...
    if (user.role !== "super_admin") {
        ...
        const assigned = activity.userAssignments.some((a) => a.userId === user.userId);
...
export async function updateActivity(user, activityId, data) {
...
export async function deleteActivity(user, activityId) {
...
export async function assignVolunteer(activityId, data, createdBy) {
...
export async function removeVolunteerAssignment(activityId, userId) {
    const existing = await prisma.userActivityAssignment.findFirst({
        where: { userId, activityId },
    });
    if (!existing) {
