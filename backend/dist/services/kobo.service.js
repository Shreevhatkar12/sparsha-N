...
export async function syncKoboForms(userId) {
    try {
        ...
        for (const asset of assets) {
            ...
            if (asset.content && asset.content.survey) {
                schema.fields = asset.content.survey.map((q) => ({
...
export async function syncKoboSubmissions(templateId, assetUid, userId, defaultCenterId) {
    try {
