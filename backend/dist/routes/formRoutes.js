...
import { createTemplateController, deleteSubmissionController, deleteTemplateController, getPendingFormsController, getStudentSubmissionsController, getSubmissionController, getTemplateController, listSubmissionsController, listTemplatesController, submitFormController, updateTemplateController, } from '../controllers/formController.js';
import { validate } from '../middleware/validate.js';
import { createFormTemplateSchema, submitFormSchema, updateFormTemplateSchema, } from '../validators/schemas.js';
...
formRoutes.put("/templates/:templateId", requirePermission(PERMISSIONS.MANAGE_FORMS), validate(updateFormTemplateSchema), updateTemplateController);
