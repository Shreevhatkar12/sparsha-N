...
import { createExamController, getExamByIdController, getExamComparisonController, getPendingExamScoresController, getStudentExamScoresController, listExamsController, upsertExamScoresController, getExamSheetController, // ✅ Merged into the main import block
...
examRoutes.post("/:examId/scores", requirePermission(PERMISSIONS.ENTER_EXAM_SCORES), validate(upsertExamScoresSchema), upsertExamScoresController);
