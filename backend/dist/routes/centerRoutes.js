...
import { assignProgramController, assignUserController, createCenterController, deleteCenterController, createProgramController, getCenterController, getProgramDetailsController, listCentersController, listProgramsController, programCentersController, removeProgramController, removeUserController, updateCenterController, updateProgramController, } from '../controllers/centerController.js';
...
centerRoutes.delete("/:centerId/programs/:programId", requirePermission(PERMISSIONS.MANAGE_CENTERS), removeProgramController);
